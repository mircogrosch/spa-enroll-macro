...
class InitMessage extends BaseRequestMessage {
    constructor(wasmLoadSettings, userId) {
        ...
        this.userId = userId;
        this.registerLoadCallback =
            wasmLoadSettings.loadProgressCallback !== null;
...
(function (ParameterType) {
    ...
    ParameterType[(ParameterType["RecognizerSettings"] = 2)] =
        "RecognizerSettings";
...
(function (MetadataCallback) {
    ...
    MetadataCallback[(MetadataCallback["onDetectionFailed"] = 1)] =
        "onDetectionFailed";
    MetadataCallback[(MetadataCallback["onQuadDetection"] = 2)] =
        "onQuadDetection";
    MetadataCallback[(MetadataCallback["onPointsDetection"] = 3)] =
        "onPointsDetection";
    MetadataCallback[(MetadataCallback["onFirstSideResult"] = 4)] =
        "onFirstSideResult";
    MetadataCallback[(MetadataCallback["clearTimeoutCallback"] = 5)] =
        "clearTimeoutCallback";
    MetadataCallback[(MetadataCallback["onGlare"] = 6)] = "onGlare";
    MetadataCallback[(MetadataCallback["recognizerCallback"] = 7)] =
        "recognizerCallback";
    ...
    currentSettings() {
        return new Promise((resolve, reject) => {
            if (this.objectHandle < 0) {
                reject(
                    "Invalid object handle: " + this.objectHandle.toString()
                );
                return;
            }
            const msg = new InvokeObjectMethod(
                this.objectHandle,
                "currentSettings",
                []
            );
...
class RemoteRecognizerRunner {
    ...
    reconfigureRecognizers(recognizers, allowMultipleResults) {
        return new Promise((resolve, reject) => {
            ...
            const msg = new ReconfigureRecognizerRunner(
                recognizerHandles,
                allowMultipleResults
            );
            const handler = defaultEventHandler(resolve, reject);
    ...
    setMetadataCallbacks(metadataCallbacks) {
        return new Promise((resolve, reject) => {
            const msg = new RegisterMetadataCallbacks(
                createRegisteredCallbacks(metadataCallbacks)
            );
            const handler = defaultEventHandler(resolve, reject);
            this.wasmSDKWorker.postMessageAndRegisterCallbacks(
                msg,
                metadataCallbacks,
                handler
            );
    ...
    setClearTimeoutCallback(clearTimeoutCallback) {
        return new Promise((resolve, reject) => {
            const msg = new SetClearTimeoutCallback(
...
class WasmModuleWorkerProxy {
    ...
    createRecognizerRunner(
        ...
        return new Promise((resolve, reject) => {
            const recognizerHandles = getRecognizerHandles(recognizers);
            const msg = new CreateRecognizerRunner(
                recognizerHandles,
                allowMultipleResults,
                createRegisteredCallbacks(metadataCallbacks)
            );
    ...
    newRecognizer(className, ...constructorArgs) {
        return new Promise((resolve, reject) => {
            const msg = new CreateNewRecognizer(
                className,
                wrapParameters(constructorArgs)
            );
            const handler = defaultResultEventHandler((msg) => {
...
class WasmSDKWorker {
    ...
    constructor(worker, loadProgressCallback, userId, rejectHandler) {
        ...
        this.mbWasmWorker.onmessage = (event) => {
        ...
        if ("isCallbackMessage" in event.data) {
            ...
            switch (msg.callbackType) {
                case MetadataCallback.onDebugText:
                    if (
                        typeof this.metadataCallbacks.onDebugText === "function"
                    ) {
                        this.metadataCallbacks.onDebugText(
                            msg.callbackParameters[0]
                        );
                    }
                    break;
                ...
                case MetadataCallback.onGlare:
                    if (typeof this.metadataCallbacks.onGlare === "function") {
                        this.metadataCallbacks.onGlare(
                            msg.callbackParameters[0]
                        );
                    }
                    break;
                case MetadataCallback.recognizerCallback: {
                    ...
                    const recognizer = this.recognizersWithCallbacks.get(
                        address.recognizerHandle
                    );
                    if (recognizer !== undefined) {
                        recognizer.invokeCallback(
                            address.callbackName,
                            msg.callbackParameters
                        );
                    } else {
                        console.warn(
                ...
                default:
                    throw new Error(
                        `Unknown callback type: ${
                            MetadataCallback[msg.callbackType]
                        }`
                    );
            }
            ...
            return new Promise((resolve, reject) => {
                ...
                const initEventHandler = defaultResultEventHandler(
                    ...
                    (error) => {
                        if (
                            wasmWorker &&
                            typeof wasmWorker.delete === "function"
                        ) {
                            wasmWorker.delete();
                        }
                        reject(error);
...
(function (ErrorCodes) {
    ...
    ErrorCodes["FRAME_CAPTURE_SVG_UNSUPPORTED"] =
...
(function (ErrorMessages) {
    ErrorMessages["WORKER_HANDLE_UNDEFINED"] =
        "Cannot find object with handle: undefined";
    ErrorMessages["WORKER_WASM_LOAD_FAILURE"] =
        "Failed to load WASM in web worker!";
    ErrorMessages["WORKER_WASM_INIT_MISSING"] =
        "WASM module is not initialized!";
    ErrorMessages["WORKER_FUNCTION_INVOKE_FAILURE"] =
        "Failed to invoke function!";
    ErrorMessages["WORKER_RECOGNIZER_CREATION_FAILURE"] =
        "Failed to create new recognizer!";
    ErrorMessages["WORKER_RUNNER_EXISTS"] =
        "Recognizer runner is already created! Multiple instances are not allowed!";
    ErrorMessages["WORKER_RUNNER_CREATION_FAILURE"] =
        "Failed to create new recognizer runner!";
    ErrorMessages["WORKER_RUNNER_MISSING"] =
        "Recognizer runner is not created! There is nothing to reconfigure!";
    ErrorMessages["WORKER_RUNNER_RECONFIGURE_FAILURE"] =
        "Failed to reconfigure recognizer runner!";
    ErrorMessages["WORKER_RUNNER_DELETED"] =
        "Recognizer runner is already deleted!";
    ErrorMessages["WORKER_RUNNER_DELETE_FAILURE"] =
        "Failed to delete recognizer runner!";
    ErrorMessages["WORKER_OBJECT_INVOKE_FAILURE"] = "Failed to invoke object!";
    ErrorMessages["WORKER_IMAGE_PROCESS_FAILURE"] =
        "Recognizer runner is not initialized! Cannot process image!";
    ErrorMessages["WORKER_INTEGRATION_INFO_FAILURE"] =
        "Failed to get product integration info!";
    ErrorMessages["LOCAL_SDK_RUNNER_MISSING"] =
        "Property nativeRecognizerRunner is not available!";
    ErrorMessages["LOCAL_SDK_RUNNER_EMPTY"] =
        "Native RecognizerRunner cannot be empty!";
    ErrorMessages["LICENSE_TOKEN_STATE_INCORRECT"] =
        "Internal error (Incorrect token state)";
    ErrorMessages["LICENSE_PAYLOAD_VERIFICATION_FAILED"] =
        "Failed to verify server permission's digital signature!";
    ErrorMessages["LICENSE_PAYLOAD_CORRUPTED"] =
        "Server permission payload is corrupted!";
    ErrorMessages["LICENSE_PERMISSION_EXPIRED"] =
        "Internal error (server permission expired)";
    ErrorMessages["LICENSE_REMOTE_LOCKED"] =
        "Provided license key has been remotely locked. Please contact support for more information!";
    ErrorMessages["FRAME_CAPTURE_SVG_UNSUPPORTED"] =
        "Recognition of SVG elements not supported!";
    ErrorMessages["FRAME_CAPTURE_CANVAS_MISSING"] =
    ...
    ErrorMessages["VIDEO_RECOGNIZER_FEED_PAUSED"] =
        "Cannot resume recognition while video feed is paused! Use recognize or startRecognition";
    ErrorMessages["VIDEO_RECOGNIZER_RECOGNIZERS_RESET_FAILURE"] =
...
(function (PreferredCameraType) {
    ...
    PreferredCameraType[(PreferredCameraType["BackFacingCamera"] = 0)] =
        "BackFacingCamera";
    /** Prefer front facing camera */
    PreferredCameraType[(PreferredCameraType["FrontFacingCamera"] = 1)] =
        "FrontFacingCamera";
            ...
            for (const camera of cameras) {
                if (isBackCameraLabel(camera.label)) {
                    ...
                    frontCameras.push(
                        new SelectedCamera(
                            camera,
                            PreferredCameraType.FrontFacingCamera
                        )
                    );
                }
            }
...
function selectCamera(cameraId, preferredCameraType) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (frontCameras.length > 0 || backCameras.length > 0) {
            ...
            let cameraPool =
                backCameras.length > 0 ? backCameras : frontCameras;
            ...
            if (
                preferredCameraType === PreferredCameraType.FrontFacingCamera &&
 ...
 */
function bindCameraToVideoFeed(
    camera,
    videoFeed,
    preferredCameraType = PreferredCameraType.BackFacingCamera
) {
...
(function (ImageOrientation) {
     ...
     * is mounted horizontally (i.e. produced image is in "landscape" orienation).
     */
    ImageOrientation[(ImageOrientation["RotatedRight90"] = 2)] =
        "RotatedRight90";
    /**
...
(function (RecognizerResultState) {
    ...
    RecognizerResultState[(RecognizerResultState["Uncertain"] = 1)] =
        "Uncertain";
    ...
    RecognizerResultState[(RecognizerResultState["StageValid"] = 3)] =
        "StageValid";
...
function isInAppBrowser() {
    const inAppRegex =
        /(instagram|fbav|linkedinapp|twitter|micromessenger|whatsapp|tiktok)[/\s]?([\w.]*)/i;
...
(function (LicenseTokenState) {
    ...
    LicenseTokenState[(LicenseTokenState["RequiresServerPermission"] = 1)] =
...
(function (ServerPermissionSubmitResultStatus) {
    ServerPermissionSubmitResultStatus[
        (ServerPermissionSubmitResultStatus["Ok"] = 0)
    ] = "Ok";
    ServerPermissionSubmitResultStatus[
        (ServerPermissionSubmitResultStatus["NetworkError"] = 1)
    ] = "NetworkError";
    ServerPermissionSubmitResultStatus[
        (ServerPermissionSubmitResultStatus["RemoteLock"] = 2)
    ] = "RemoteLock";
    ServerPermissionSubmitResultStatus[
        (ServerPermissionSubmitResultStatus["PermissionExpired"] = 3)
    ] = "PermissionExpired";
    ServerPermissionSubmitResultStatus[
        (ServerPermissionSubmitResultStatus["PayloadCorrupted"] = 4)
    ] = "PayloadCorrupted";
    ServerPermissionSubmitResultStatus[
        (ServerPermissionSubmitResultStatus[
    ...
    ServerPermissionSubmitResultStatus[
        (ServerPermissionSubmitResultStatus["IncorrectTokenState"] = 6)
    ] = "IncorrectTokenState";
})(
    ServerPermissionSubmitResultStatus ||
        (ServerPermissionSubmitResultStatus = {})
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const result =
                    wasmModule.submitServerPermission(serverPermission);
                return result;
            } else {
                return {
            ...
            return {
                status: ServerPermissionSubmitResultStatus.NetworkError,
                lease: 0,
                networkErrorDescription: `Unexpected error: ${JSON.stringify(
                    error
                )}`,
            };
        }
        ...
        switch (unlockResult.unlockResult) {
            case LicenseTokenState.Invalid:
                return {
                    error: new SDKError(
                        Object.assign(
                            Object.assign({}, licenseErrors.licenseInvalid),
            ...
            case LicenseTokenState.RequiresServerPermission: {
                const serverPermission = yield obtainNewServerPermission(
                    unlockResult,
                    wasmModule
                );
                switch (serverPermission.status) {
                    ...
                    case ServerPermissionSubmitResultStatus.NetworkError: {
                        ...
                        if (serverPermission.networkErrorDescription) {
                            additionalInfo =
                                " " + serverPermission.networkErrorDescription;
                        }
                        return {
                            error: new SDKError(
                                Object.assign(
                    ...
                    case ServerPermissionSubmitResultStatus.RemoteLock:
                        return {
                            error: new SDKError(
                                licenseErrors.licenseRemoteLocked,
                                {
                    ...
                    case ServerPermissionSubmitResultStatus.PermissionExpired:
                        return {
                            error: new SDKError(
                                licenseErrors.licensePermissionExpired,
                                {
                    ...
                    case ServerPermissionSubmitResultStatus.PayloadCorrupted:
                        return {
                            error: new SDKError(
                                licenseErrors.licensePayloadCorrupted,
                                {
                    ...
                    case ServerPermissionSubmitResultStatus.PayloadSignatureVerificationFailed:
                        return {
                            error: new SDKError(
                                licenseErrors.licensePayloadVerificationFailed,
                                {
                    ...
                    case ServerPermissionSubmitResultStatus.IncorrectTokenState:
                        return {
                            error: new SDKError(
                                licenseErrors.licenseTokenStateIncorrect,
                                {
...
(function (DetectionStatus) {
    ...
    DetectionStatus[(DetectionStatus["FallbackSuccess"] = 3)] =
        "FallbackSuccess";
    ...
    DetectionStatus[(DetectionStatus["DocumentTooCloseToEdge"] = 7)] =
...
class VideoRecognizer {
            ...
            return new Promise((resolve, reject) =>
                __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (!cameraFeed || !(cameraFeed instanceof Element)) {
                        reject(
                            new SDKError(videoRecognizerErrors.elementMissing, {
                    ...
                    if (
                        ...
                        try {
                            const selectedCamera = yield selectCamera(
                                cameraId,
                                preferredCameraType
                            );
                            if (selectedCamera === null) {
                                reject(
                                    new SDKError(
                                        videoRecognizerErrors.cameraMissing,
                                        {
                            ...
                            const cameraFlipped = yield bindCameraToVideoFeed(
                                selectedCamera,
                                cameraFeed,
                                preferredCameraType
                            );
                            // TODO: await maybe not needed here
                            yield recognizerRunner.setCameraPreviewMirrored(
                                cameraFlipped
                            );
                            resolve(
                                new VideoRecognizer(
                            ...
                            switch (error.name) {
                                ...
                                case "OverconstrainedError":
                                    errorReason =
                                        NotSupportedReason.CameraNotFound;
                                    errorCode =
                                        ErrorCodes.VIDEO_RECOGNIZER_CAMERA_MISSING;
                                    break;
                                ...
                                case "SecurityError":
                                    errorReason =
                                        NotSupportedReason.CameraNotAllowed;
                                    errorCode =
                                        ErrorCodes.VIDEO_RECOGNIZER_CAMERA_NOT_ALLOWED;
                                    break;
                                case "AbortError":
                                case "NotReadableError":
                                    errorReason =
                                        NotSupportedReason.CameraNotAvailable;
                                    errorCode =
                                        ErrorCodes.VIDEO_RECOGNIZER_CAMERA_UNAVAILABLE;
                                    break;
                        ...
                        reject(
                            new SDKError(
                                videoRecognizerErrors.mediaDevicesUnsupported,
                                {
    ...
    setVideoRecognitionMode(videoRecognitionMode) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const isDetectionMode =
                this.videoRecognitionMode ===
                VideoRecognitionMode.DetectionTest;
    ...
    startRecognition(onScanningDone, recognitionTimeoutMs = 20000) {
        return new Promise((resolve, reject) => {
            ...
            void this.recognizerRunner.setClearTimeoutCallback({
            ...
            this.videoFeed.play().then(
                ...
                (nativeError) => {
                    if (!this.allowManualVideoPlayout) {
                        reject(
                            new SDKError(
                                videoRecognizerErrors.playRequestInterrupted,
                                nativeError
                            )
                        );
                        return;
    ...
    releaseVideoFeed() {
        ...
        if (
            !this.videoFeed ||
            ((_a = this.videoFeed) === null || _a === void 0
                ? void 0
                : _a.readyState) <
                ((_b = this.videoFeed) === null || _b === void 0
                    ? void 0
                    : _b.HAVE_CURRENT_DATA)
        ) {
    ...
    changeCameraDevice(camera) {
        return new Promise((resolve, reject) => {
            ...
            this.pauseRecognition();
            clearVideoFeed(this.videoFeed);
            bindCameraToVideoFeed(camera, this.videoFeed)
                .then(() => {
                    if (this.videoFeed === null) {
                        reject(new SDKError(videoRecognizerErrors.feedMissing));
                        return;
                    ...
                    this.videoFeed.play().then(
                        ...
                        (nativeError) => {
                            ...
                            if (!this.videoFeed) {
                                reject(
                                    new SDKError(
                                        videoRecognizerErrors.feedMissing
                                    )
                                );
                                return;
                            }
        ...
        return new Promise((resolve, reject) => {
            ...
            this.recognizerRunner
                ...
                .then((processResult) => {
                    ...
                    if (
                        processResult === RecognizerResultState.Valid ||
                        this.cancelled ||
                        this.timedOut
                    ) {
                        if (
                        ...
                        processResult === RecognizerResultState.Uncertain
                    ) {
                        if (this.timeoutID === 0) {
                        ...
                        processResult === RecognizerResultState.StageValid
                    ) {
...
function loadWasmModule(loadSettings) {
  ...
  `,
                ...
                WasmSDKWorker.createWasmWorker(
                    worker,
                    loadSettings,
                    userId
                ).then((wasmSDK) => {
 ...
 */
function createRecognizerRunner(
    wasmSDK,
    recognizers,
    allowMultipleResults = false,
    metadataCallbacks = {}
...
function createSuccessFrameGrabberRecognizer(wasmSDK, slaveRecognizer) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const sfgr = yield wasmSDK.mbWasmModule.newRecognizer(
...
(function (AnonymizationMode) {
     ...
     */
    AnonymizationMode[(AnonymizationMode["ResultFieldsOnly"] = 2)] =
        "ResultFieldsOnly";
    /**
...
(function (BarcodeElementKey) {
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["StandardVersionNumber"] = 1)] =
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["CustomerFamilyName"] = 2)] =
        "CustomerFamilyName";
    /**
       Mandatory on all AAMVA, Magnetic and Compact barcodes.
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["CustomerFirstName"] = 3)] =
        "CustomerFirstName";
    /**
       Mandatory on all AAMVA, Magnetic and Compact barcodes.
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["CustomerFullName"] = 4)] =
        "CustomerFullName";
    /**
       Mandatory on all AAMVA, Magnetic and Compact barcodes.
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["AddressStreet"] = 8)] =
        "AddressStreet";
    /**
       Mandatory on all AAMVA and Magnetic barcodes.
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["AddressJurisdictionCode"] = 10)] =
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["AddressPostalCode"] = 11)] =
        "AddressPostalCode";
    /**
       Mandatory on all AAMVA and Magnetic barcodes.
       Optional on Compact barcodes.
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["CustomerMiddleName"] = 16)] =
        "CustomerMiddleName";
    /**
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["AKAFamilyName"] = 20)] =
        "AKAFamilyName";
    /**
       Optional on all AAMVA and Compact barcodes.
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["AKAGivenName"] = 21)] =
        "AKAGivenName";
    /**
       Optional on all AAMVA and Compact barcodes.
       ...
       9TH        Ninth
       */
    BarcodeElementKey[(BarcodeElementKey["AKASuffixName"] = 22)] =
        "AKASuffixName";
    /**
       Mandatory on AAMVA 02 barcodes.
       Optional on AAMVA 01, 03, 04, 05, 06, 07, 08, Magnetic and Compact barcodes.
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["WeightPounds"] = 24)] =
        "WeightPounds";
    /**
       Mandatory on AAMVA 02 barcodes.
       Optional on AAMVA 01, 03, 04, 05, 06, 07, 08, Magnetic and Compact barcodes.
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["WeightKilograms"] = 25)] =
        "WeightKilograms";
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["CustomerIdNumber"] = 26)] =
        "CustomerIdNumber";
    /**
       Mandatory on AAMVA 04, 05, 06, 07, 08 barcodes.
       Optional on Compact barcodes.
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["FamilyNameTruncation"] = 27)] =
    ...
    /**
       ...
       truncated (N), or – unknown whether truncated (U).
       */
    BarcodeElementKey[(BarcodeElementKey["FirstNameTruncation"] = 28)] =
        "FirstNameTruncation";
    /**
       Mandatory on AAMVA 04, 05, 06, 07, 08 barcodes.
       ...
       truncated (N), or – unknown whether truncated (U).
       */
    BarcodeElementKey[(BarcodeElementKey["MiddleNameTruncation"] = 29)] =
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["PlaceOfBirth"] = 30)] =
        "PlaceOfBirth";
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["AddressStreet2"] = 31)] =
        "AddressStreet2";
    /**
       Optional on AAMVA 02, 03, 04, 05, 06, 07, 08 and Compact barcodes.
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["RaceEthnicity"] = 32)] =
        "RaceEthnicity";
    /**
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["CountryIdentification"] = 34)] =
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["ResidenceStreetAddress"] = 35)] =
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["ResidenceStreetAddress2"] = 36)] =
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["ResidenceCity"] = 37)] =
        "ResidenceCity";
    /**
       Optional on AAMVA version 01.
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["ResidenceJurisdictionCode"] = 38)] =
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["ResidencePostalCode"] = 39)] =
        "ResidencePostalCode";
    /**
       Optional on AAMVA 01 barcodes.
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["ResidenceFullAddress"] = 40)] =
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["SocialSecurityNumber"] = 44)] =
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["AKASocialSecurityNumber"] = 45)] =
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["AKAMiddleName"] = 46)] =
        "AKAMiddleName";
    /**
       Optional on AAMVA 01 barcodes.
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["AKAPrefixName"] = 47)] =
        "AKAPrefixName";
    /**
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["AKADateOfBirth"] = 50)] =
        "AKADateOfBirth";
    // ==============================================================/
    // ==========          3. LICENSE DATA KEYS          ============/
    // ==============================================================/
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["IssuerIdentificationNumber"] = 51)] =
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["DocumentExpirationDate"] = 52)] =
    ...
    /**
       ...
       Version 00.
       */
    BarcodeElementKey[(BarcodeElementKey["JurisdictionVersionNumber"] = 53)] =
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["JurisdictionVehicleClass"] = 54)] =
    ...
    /**
       ...
       */
    BarcodeElementKey[
        (BarcodeElementKey["JurisdictionRestrictionCodes"] = 55)
    ...
    /**
       ...
       */
    BarcodeElementKey[
        (BarcodeElementKey["JurisdictionEndorsementCodes"] = 56)
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["DocumentIssueDate"] = 57)] =
        "DocumentIssueDate";
    /**
       ...
       */
    BarcodeElementKey[
        (BarcodeElementKey["FederalCommercialVehicleCodes"] = 58)
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["IssuingJurisdiction"] = 59)] =
        "IssuingJurisdiction";
    /**
       Optional on all AAMVA barcodes.
       Mandatory on Compact barcodes.
       ...
       */
    BarcodeElementKey[
        (BarcodeElementKey["StandardVehicleClassification"] = 60)
    ...
    /**
        ...
        */
    BarcodeElementKey[(BarcodeElementKey["IssuingJurisdictionName"] = 61)] =
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["StandardEndorsementCode"] = 62)] =
    ...
    /**
       ...
       W      Farm Waiver
       */
    BarcodeElementKey[(BarcodeElementKey["StandardRestrictionCode"] = 63)] =
    ...
    /**
       ...
       */
    BarcodeElementKey[
        (BarcodeElementKey["JurisdictionVehicleClassificationDescription"] = 64)
    ...
    /**
       ...
       */
    BarcodeElementKey[
        (BarcodeElementKey["JurisdictionEndorsmentCodeDescription"] = 65)
    ...
    /**
       ...
       */
    BarcodeElementKey[
        (BarcodeElementKey["JurisdictionRestrictionCodeDescription"] = 66)
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["InventoryControlNumber"] = 67)] =
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["CardRevisionDate"] = 68)] =
        "CardRevisionDate";
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["DocumentDiscriminator"] = 69)] =
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["LimitedDurationDocument"] = 70)] =
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["AuditInformation"] = 71)] =
        "AuditInformation";
    /**
       Optional on AAMVA 04, 05, 06, 07, 08 and Compact barcodes.
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["ComplianceType"] = 72)] =
        "ComplianceType";
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["IssueTimestamp"] = 73)] =
        "IssueTimestamp";
    /**
       Optional on AAMVA version 01 barcodes.
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["PermitExpirationDate"] = 74)] =
    ...
    /**
       ...
       Type of permit.
       */
    BarcodeElementKey[(BarcodeElementKey["PermitIdentifier"] = 75)] =
        "PermitIdentifier";
    /**
       Optional on AAMVA version 01 barcodes..
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["PermitIssueDate"] = 76)] =
        "PermitIssueDate";
    /**
       Optional on AAMVA version 01.
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["NumberOfDuplicates"] = 77)] =
        "NumberOfDuplicates";
    /**
       Optional on AAMVA 04, 05, 06, 07, 08 and Compact barcodes.
       ...
       no longer valid. (MMDDCCYY format)
       */
    BarcodeElementKey[(BarcodeElementKey["HAZMATExpirationDate"] = 78)] =
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["MedicalIndicator"] = 79)] =
        "MedicalIndicator";
    /**
       Optional on AAMVA version 01.
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["UniqueCustomerId"] = 81)] =
        "UniqueCustomerId";
    /**
       Optional on compact barcodes.
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["DataDiscriminator"] = 82)] =
        "DataDiscriminator";
    /**
       Optional on Magnetic barcodes.
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["DocumentExpirationMonth"] = 83)] =
    ...
    /**
       ...
       */
    BarcodeElementKey[(BarcodeElementKey["DocumentNonexpiring"] = 84)] =
        "DocumentNonexpiring";
    /**
        Optional on Magnetic barcodes.
      ...
      */
    BarcodeElementKey[(BarcodeElementKey["SecurityVersion"] = 85)] =
        "SecurityVersion";
    /**
...
(function (Country) {
    ...
    Country[(Country["BOSNIA_AND_HERZEGOVINA"] = 10)] =
    ...
    Country[(Country["CENTRAL_AFRICAN_REPUBLIC"] = 133)] =
    ...
    Country[(Country["DEMOCRATIC_REPUBLIC_OF_THE_CONGO"] = 142)] =
    ...
    Country[(Country["FEDERATED_STATES_OF_MICRONESIA"] = 151)] =
    ...
    Country[(Country["FRENCH_SOUTHERN_TERRITORIES"] = 155)] =
    ...
    Country[(Country["HEARD_ISLAND_AND_MCDONALD_ISLANDS"] = 166)] =
    ...
    Country[(Country["NORTHERN_MARIANA_ISLANDS"] = 202)] =
    ...
    Country[(Country["SAINT_HELENA_ASCENSION_AND_TRISTIAN_DA_CUNHA"] = 212)] =
    ...
    Country[(Country["SAINT_PIERRE_AND_MIQUELON"] = 216)] =
        "SAINT_PIERRE_AND_MIQUELON";
    Country[(Country["SAINT_VINCENT_AND_THE_GRENADINES"] = 217)] =
    ...
    Country[(Country["TURKS_AND_CAICOS_ISLANDS"] = 241)] =
        "TURKS_AND_CAICOS_ISLANDS";
    Country[(Country["TUVALU"] = 242)] = "TUVALU";
    Country[(Country["UNITED_STATES_MINOR_OUTLYING_ISLANDS"] = 243)] =
    ...
    Country[(Country["VIRGIN_ISLANDS_BRITISH"] = 247)] =
...
(function (Region) {
    ...
    Region[(Region["AUSTRALIAN_CAPITAL_TERRITORY"] = 6)] =
    ...
    Region[(Region["NEWFOUNDLAND_AND_LABRADOR"] = 71)] =
    ...
    Region[(Region["QUINTANA_ROO_BENITO_JUAREZ"] = 113)] =
        "QUINTANA_ROO_BENITO_JUAREZ";
    Region[(Region["UINTANA_ROO"] = 114)] = "UINTANA_ROO";
    Region[(Region["QUINTANA_ROO_SOLIDARIDAD"] = 115)] =
...
(function (DocumentType) {
    ...
    DocumentType[(DocumentType["DL_PUBLIC_SERVICES_CARD"] = 3)] =
    ...
    DocumentType[(DocumentType["PUBLIC_SERVICES_CARD"] = 14)] =
    ...
    DocumentType[(DocumentType["TEMPORARY_RESIDENCE_PERMIT"] = 17)] =
    ...
    DocumentType[(DocumentType["SOCIAL_SECURITY_CARD"] = 23)] =
        "SOCIAL_SECURITY_CARD";
    DocumentType[(DocumentType["HEALTH_INSURANCE_CARD"] = 24)] =
    ...
    DocumentType[(DocumentType["BORDER_CROSSING_CARD"] = 37)] =
        "BORDER_CROSSING_CARD";
    DocumentType[(DocumentType["DRIVER_CARD"] = 38)] = "DRIVER_CARD";
    DocumentType[(DocumentType["GLOBAL_ENTRY_CARD"] = 39)] =
        "GLOBAL_ENTRY_CARD";
    ...
    DocumentType[(DocumentType["PROOF_OF_AGE_CARD"] = 43)] =
        "PROOF_OF_AGE_CARD";
    ...
    DocumentType[(DocumentType["CITIZENSHIP_CERTIFICATE"] = 47)] =
...
(function (DocumentImageColorStatus) {
    ...
    DocumentImageColorStatus[(DocumentImageColorStatus["NotAvailable"] = 0)] =
        "NotAvailable";
    /** Black-and-white image scanned */
    DocumentImageColorStatus[(DocumentImageColorStatus["BlackAndWhite"] = 1)] =
        "BlackAndWhite";
    /** Color image scanned */
...
(function (ImageAnalysisDetectionStatus) {
    ...
    ImageAnalysisDetectionStatus[
        (ImageAnalysisDetectionStatus["NotAvailable"] = 0)
    ] = "NotAvailable";
    /** Object not detected on input image */
    ImageAnalysisDetectionStatus[
        (ImageAnalysisDetectionStatus["NotDetected"] = 1)
    ] = "NotDetected";
    /** Object detected on input image */
    ImageAnalysisDetectionStatus[
        (ImageAnalysisDetectionStatus["Detected"] = 2)
    ] = "Detected";
...
(function (ProcessingStatus) {
    ...
    ProcessingStatus[(ProcessingStatus["DetectionFailed"] = 1)] =
        "DetectionFailed";
    /** Preprocessing of the input image has failed. */
    ProcessingStatus[(ProcessingStatus["ImagePreprocessingFailed"] = 2)] =
        "ImagePreprocessingFailed";
    /** Recognizer has inconsistent results. */
    ProcessingStatus[(ProcessingStatus["StabilityTestFailed"] = 3)] =
        "StabilityTestFailed";
    /** Wrong side of the document has been scanned. */
    ProcessingStatus[(ProcessingStatus["ScanningWrongSide"] = 4)] =
        "ScanningWrongSide";
    /** Identification of the fields present on the document has failed. */
    ProcessingStatus[(ProcessingStatus["FieldIdentificationFailed"] = 5)] =
        "FieldIdentificationFailed";
    /** Mandatory field for the specific document is missing. */
    ProcessingStatus[(ProcessingStatus["MandatoryFieldMissing"] = 6)] =
        "MandatoryFieldMissing";
    /** Result contains invalid characters in some of the fields. */
    ProcessingStatus[(ProcessingStatus["InvalidCharactersFound"] = 7)] =
        "InvalidCharactersFound";
    /** Failed to return a requested image. */
    ProcessingStatus[(ProcessingStatus["ImageReturnFailed"] = 8)] =
        "ImageReturnFailed";
    /** Reading or parsing of the barcode has failed. */
    ProcessingStatus[(ProcessingStatus["BarcodeRecognitionFailed"] = 9)] =
        "BarcodeRecognitionFailed";
    /** Parsing of the MRZ has failed. */
    ProcessingStatus[(ProcessingStatus["MrzParsingFailed"] = 10)] =
        "MrzParsingFailed";
    /** Document class has been filtered out. */
    ProcessingStatus[(ProcessingStatus["ClassFiltered"] = 11)] =
        "ClassFiltered";
    /** Document currently not supported by the recognizer. */
    ProcessingStatus[(ProcessingStatus["UnsupportedClass"] = 12)] =
        "UnsupportedClass";
    /** License for the detected document is missing. */
    ProcessingStatus[(ProcessingStatus["UnsupportedByLicense"] = 13)] =
        "UnsupportedByLicense";
    /**
     * Front side recognition has completed successfully, and recognizer is waiting for the other
     * side to be scanned.
     */
    ProcessingStatus[(ProcessingStatus["AwaitingOtherSide"] = 14)] =
        "AwaitingOtherSide";
...
(function (RecognitionMode) {
    ...
    RecognitionMode[(RecognitionMode["FullRecognition"] = 5)] =
        "FullRecognition";
...
(function (IdBarcodeDocumentType) {
     ...
     */
    IdBarcodeDocumentType[(IdBarcodeDocumentType["AAMVACompliant"] = 1)] =
        "AAMVACompliant";
    /**
     * ArgentinaID document was scanned
     */
    IdBarcodeDocumentType[(IdBarcodeDocumentType["ArgentinaID"] = 2)] =
        "ArgentinaID";
    /**
     * ArgentinaAlienID document was scanned
     */
    IdBarcodeDocumentType[(IdBarcodeDocumentType["ArgentinaAlienID"] = 3)] =
        "ArgentinaAlienID";
    /**
     * ArgentinaDL document was scanned
     */
    IdBarcodeDocumentType[(IdBarcodeDocumentType["ArgentinaDL"] = 4)] =
        "ArgentinaDL";
    /**
     * ColombiaID document was scanned
     */
    IdBarcodeDocumentType[(IdBarcodeDocumentType["ColombiaID"] = 5)] =
        "ColombiaID";
    /**
     * ColombiaDL document was scanned
     */
    IdBarcodeDocumentType[(IdBarcodeDocumentType["ColombiaDL"] = 6)] =
        "ColombiaDL";
    /**
     * NigeriaVoterID document was scanned
     */
    IdBarcodeDocumentType[(IdBarcodeDocumentType["NigeriaVoterID"] = 7)] =
        "NigeriaVoterID";
    /**
     * NigeriaDL document was scanned
     */
    IdBarcodeDocumentType[(IdBarcodeDocumentType["NigeriaDL"] = 8)] =
        "NigeriaDL";
    /**
     ...
     */
    IdBarcodeDocumentType[(IdBarcodeDocumentType["SouthAfricaID"] = 10)] =
        "SouthAfricaID";
